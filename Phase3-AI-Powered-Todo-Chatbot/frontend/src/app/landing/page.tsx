...
import { CheckCircle2, Brain, MessageSquare, Sparkles, Github, Linkedin, ArrowRight } from 'lucide-react';
...
export default function LandingPage() {
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white">
            ...
            <div className="fixed top-0 left-1/4 w-[600px] h-[600px] bg-purple-500/5 rounded-full blur-3xl" />
            <div className="fixed bottom-0 right-1/4 w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-3xl" />
            ...
            <main className="relative z-10">
                <section className="max-w-6xl mx-auto px-6 pt-24 pb-16 text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-purple-500/10 border border-purple-500/30 rounded-full text-xs text-purple-400 mb-8">
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
                        AI-Powered
                        <br />
                        <span className="text-neutral-500">Task Management.</span>
                    </h1>

                    <p className="text-neutral-400 text-lg md:text-xl max-w-2xl mx-auto mb-10">
                        Supercharge your productivity with AI. Chat with your tasks, get smart suggestions,
                        and let AI help you organize your day.
                    </p>
                ...
                <section className="max-w-6xl mx-auto px-6 py-20">
                    <h2 className="text-2xl font-semibold text-center mb-12">AI Features</h2>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <FeatureCard
                            icon={<MessageSquare className="w-5 h-5" />}
                            title="AI Chat Assistant"
                            description="Chat with AI to manage tasks - create, update, and organize with natural language."
                        />
                        <FeatureCard
                            icon={<Brain className="w-5 h-5" />}
                            title="Smart Suggestions"
                            description="Get intelligent task suggestions based on your patterns and goals."
                        />
                        <FeatureCard
                            icon={<Sparkles className="w-5 h-5" />}
                            title="Powered by Groq"
                            description="Ultra-fast AI responses using Groq's LPU inference technology."
                        />
                    </div>
                </section>
                ...
                <section className="max-w-6xl mx-auto px-6 py-16">
                    <div className="bg-neutral-900/50 border border-neutral-800 rounded-2xl p-8 text-center">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-4">
                            {['Next.js', 'TypeScript', 'Tailwind CSS', 'FastAPI', 'Groq AI', 'LangChain'].map((tech) => (
